...
namespace kaitai
{
    ...
    public:
        ...
        private:
            ...
            std::unique_ptr<vector_types_t::vec3_t> m_lower_limitation_angle;
        ...
        private:
            std::unique_ptr<vector_types_t::vec3_t> m_upper_limitation_angle;
        ...
        public:
            ...
            vector_types_t::vec3_t *lower_limitation_angle() const { return m_lower_limitation_angle.get(); }
            vector_types_t::vec3_t *upper_limitation_angle() const { return m_upper_limitation_angle.get(); }
        ...
        private:
            ...
            std::unique_ptr<vector_types_t::vec3_t> m_normal;
            std::unique_ptr<vector_types_t::vec2_t> m_uv;
            std::unique_ptr<std::vector<std::unique_ptr<vector_types_t::vec4_t>>> m_additional_uvs;
            bone_type_t m_type;
        ...
        public:
             ...
             */
            vector_types_t::vec3_t *normal() const { return m_normal.get(); }

            /**
             * texture coordinate.
             */
            vector_types_t::vec2_t *uv() const { return m_uv.get(); }
            std::vector<std::unique_ptr<vector_types_t::vec4_t>> *additional_uvs() const { return m_additional_uvs.get(); }
        ...
        private:
            std::unique_ptr<sized_index_t> m_index;
            uint8_t m_type;
            std::unique_ptr<vector_types_t::color4_t> m_diffuse;
            std::unique_ptr<vector_types_t::color3_t> m_specular;
            float m_shininess;
            std::unique_ptr<vector_types_t::color3_t> m_ambient;
            std::unique_ptr<vector_types_t::color4_t> m_edge_color;
            float m_edge_size;
            std::unique_ptr<vector_types_t::color4_t> m_texture_color;
            std::unique_ptr<vector_types_t::color4_t> m_sphere_texture_color;
            std::unique_ptr<vector_types_t::color4_t> m_toon_color;
            mmd_pmx_t *m__root;
        ...
        public:
            ...
            vector_types_t::color4_t *diffuse() const { return m_diffuse.get(); }
            vector_types_t::color3_t *specular() const { return m_specular.get(); }
            float shininess() const { return m_shininess; }
            vector_types_t::color3_t *ambient() const { return m_ambient.get(); }
            vector_types_t::color4_t *edge_color() const { return m_edge_color.get(); }
            float edge_size() const { return m_edge_size; }
            vector_types_t::color4_t *texture_color() const { return m_texture_color.get(); }
            vector_types_t::color4_t *sphere_texture_color() const { return m_sphere_texture_color.get(); }
            vector_types_t::color4_t *toon_color() const { return m_toon_color.get(); }
            mmd_pmx_t *_root() const { return m__root; }
        ...
        private:
            ...
            float m_weight1;
            std::unique_ptr<vector_types_t::vec3_t> m_c;
            std::unique_ptr<vector_types_t::vec3_t> m_r0;
            std::unique_ptr<vector_types_t::vec3_t> m_r1;
            mmd_pmx_t *m__root;
            mmd_pmx_t::vertex_t *m__parent;
        ...
        public:
            ...
            vector_types_t::vec3_t *c() const { return m_c.get(); }
            vector_types_t::vec3_t *r0() const { return m_r0.get(); }
            vector_types_t::vec3_t *r1() const { return m_r1.get(); }
            mmd_pmx_t *_root() const { return m__root; }
            mmd_pmx_t::vertex_t *_parent() const { return m__parent; }
        };
        ...
        private:
            ...
            std::unique_ptr<vector_types_t::vec3_t> m_position_constraint_lower;
            std::unique_ptr<vector_types_t::vec3_t> m_position_constraint_upper;
            std::unique_ptr<vector_types_t::vec3_t> m_rotation_constraint_lower;
            std::unique_ptr<vector_types_t::vec3_t> m_rotation_constraint_upper;
            std::unique_ptr<vector_types_t::vec3_t> m_spring_position;
            std::unique_ptr<vector_types_t::vec3_t> m_spring_rotation;
            mmd_pmx_t *m__root;
            mmd_pmx_t *m__parent;
        ...
        public:
            ...
            vector_types_t::vec3_t *position_constraint_lower() const { return m_position_constraint_lower.get(); }
            vector_types_t::vec3_t *position_constraint_upper() const { return m_position_constraint_upper.get(); }
            vector_types_t::vec3_t *rotation_constraint_lower() const { return m_rotation_constraint_lower.get(); }
            vector_types_t::vec3_t *rotation_constraint_upper() const { return m_rotation_constraint_upper.get(); }
            vector_types_t::vec3_t *spring_position() const { return m_spring_position.get(); }
            vector_types_t::vec3_t *spring_rotation() const { return m_spring_rotation.get(); }
            mmd_pmx_t *_root() const { return m__root; }
            mmd_pmx_t *_parent() const { return m__parent; }
        };
        ...
        private:
            std::unique_ptr<vector_types_t::vec3_t> m_offset_position;
        ...
        private:
            std::unique_ptr<vector_types_t::vec3_t> m_fixed_axis;
            bool n_fixed_axis;
        ...
        private:
            std::unique_ptr<vector_types_t::vec3_t> m_local_x_vector;
        ...
        private:
            std::unique_ptr<vector_types_t::vec3_t> m_local_z_vector;
        ...
        public:
            ...
            vector_types_t::vec3_t *offset_position() const { return m_offset_position.get(); }
            bone_grant_t *grant() const { return m_grant.get(); }
            vector_types_t::vec3_t *fixed_axis() const { return m_fixed_axis.get(); }
            vector_types_t::vec3_t *local_x_vector() const { return m_local_x_vector.get(); }
            vector_types_t::vec3_t *local_z_vector() const { return m_local_z_vector.get(); }
        ...
        private:
            ...
            uint8_t m_local;
            std::unique_ptr<vector_types_t::vec3_t> m_translational_velocity;
            std::unique_ptr<vector_types_t::vec3_t> m_angular_velocity;
            mmd_pmx_t *m__root;
            mmd_pmx_t::morph_t *m__parent;
        ...
        public:
            ...
            vector_types_t::vec3_t *translational_velocity() const { return m_translational_velocity.get(); }
             ...
             */
            vector_types_t::vec3_t *angular_velocity() const { return m_angular_velocity.get(); }
            mmd_pmx_t *_root() const { return m__root; }
            mmd_pmx_t::morph_t *_parent() const { return m__parent; }
        };
        ...
        private:
            std::unique_ptr<sized_index_t> m_index;
            std::unique_ptr<vector_types_t::vec4_t> m_uv;
            mmd_pmx_t *m__root;
            mmd_pmx_t::morph_t *m__parent;

        public:
            sized_index_t *index() const { return m_index.get(); }
            vector_types_t::vec4_t *uv() const { return m_uv.get(); }
            mmd_pmx_t *_root() const { return m__root; }
            mmd_pmx_t::morph_t *_parent() const { return m__parent; }
        };
