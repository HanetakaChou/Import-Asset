...
namespace kaitai
{
    ...
    void mmd_pmx_t::bone_ik_link_t::_read()
    {
        ...
        if (angle_limitation() == 1)
        {
            ...
            m_lower_limitation_angle = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        }
        n_upper_limitation_angle = true;
        if (angle_limitation() == 1)
        {
            n_upper_limitation_angle = false;
            m_upper_limitation_angle = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        }
    }
    ...
    {
        m_position = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_normal = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_uv = std::unique_ptr<vector_types_t::vec2_t>(new vector_types_t::vec2_t(m__io, this, m__root));
        m_additional_uvs = std::unique_ptr<std::vector<std::unique_ptr<vector_types_t::vec4_t>>>(new std::vector<std::unique_ptr<vector_types_t::vec4_t>>());
        const int l_additional_uvs = _root()->header()->additional_uv_count();
        for (int i = 0; i < l_additional_uvs; i++)
        {
            m_additional_uvs->push_back(std::move(std::unique_ptr<vector_types_t::vec4_t>(new vector_types_t::vec4_t(m__io, this, m__root))));
        }
    ...
    void mmd_pmx_t::material_morph_element_t::_read()
    {
        ...
        m_diffuse = std::unique_ptr<vector_types_t::color4_t>(new vector_types_t::color4_t(m__io, this, m__root));
        m_specular = std::unique_ptr<vector_types_t::color3_t>(new vector_types_t::color3_t(m__io, this, m__root));
        m_shininess = m__io->read_f4le();
        m_ambient = std::unique_ptr<vector_types_t::color3_t>(new vector_types_t::color3_t(m__io, this, m__root));
        m_edge_color = std::unique_ptr<vector_types_t::color4_t>(new vector_types_t::color4_t(m__io, this, m__root));
        m_edge_size = m__io->read_f4le();
        m_texture_color = std::unique_ptr<vector_types_t::color4_t>(new vector_types_t::color4_t(m__io, this, m__root));
        m_sphere_texture_color = std::unique_ptr<vector_types_t::color4_t>(new vector_types_t::color4_t(m__io, this, m__root));
        m_toon_color = std::unique_ptr<vector_types_t::color4_t>(new vector_types_t::color4_t(m__io, this, m__root));
    }
    ...
    void mmd_pmx_t::bone_morph_element_t::_read()
    {
        m_index = std::unique_ptr<sized_index_t>(new sized_index_t(_root()->header()->bone_index_size(), m__io, this, m__root));
        m_position = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_rotation = std::unique_ptr<vector_types_t::vec4_t>(new vector_types_t::vec4_t(m__io, this, m__root));
    }
    ...
    void mmd_pmx_t::sdef_weights_t::_read()
    {
        ...
        m_c = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_r0 = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_r1 = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
    }
    ...
    void mmd_pmx_t::joint_t::_read()
    {
        ...
        m_position = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_rotation = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_position_constraint_lower = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_position_constraint_upper = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_rotation_constraint_lower = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_rotation_constraint_upper = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_spring_position = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_spring_rotation = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
    }
    ...
    void mmd_pmx_t::bone_t::_read()
    {
        ...
        if (!(indexed_tail_position()))
        {
            ...
            m_offset_position = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        }
        n_grant = true;
        ...
        {
            n_fixed_axis = false;
            m_fixed_axis = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        }
        n_local_x_vector = true;
        if (has_local_axes())
        {
            n_local_x_vector = false;
            m_local_x_vector = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        }
        n_local_z_vector = true;
        if (has_local_axes())
        {
            n_local_z_vector = false;
            m_local_z_vector = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        }
        n_key = true;
    ...
    void mmd_pmx_t::impulse_morph_element_t::_read()
    {
        ...
        m_translational_velocity = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
        m_angular_velocity = std::unique_ptr<vector_types_t::vec3_t>(new vector_types_t::vec3_t(m__io, this, m__root));
    }
    ...
    {
        m_index = std::unique_ptr<sized_index_t>(new sized_index_t(_root()->header()->vertex_index_size(), m__io, this, m__root));
        m_uv = std::unique_ptr<vector_types_t::vec4_t>(new vector_types_t::vec4_t(m__io, this, m__root));
    }
