...
static inline DirectX::XMMATRIX XM_CALLCONV DirectX_Math_Matrix_XMMatrixPerspectiveFovLH_ReversedZ(float FovAngleY, float AspectRatio, float NearZ, float FarZ) noexcept
{
