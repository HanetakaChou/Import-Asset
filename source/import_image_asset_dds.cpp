...
//--------------------------------------------------------------------------------------
extern bool import_image_asset_header_from_input_stream_dds(import_asset_input_stream *input_stream, BRX_SAMPLED_ASSET_IMAGE_IMPORT_HEADER *image_asset_header, size_t *image_asset_data_offset)
{
    ...
    BRX_SAMPLED_ASSET_IMAGE_TYPE res_dim = static_cast<BRX_SAMPLED_ASSET_IMAGE_TYPE>(-1);
    ...
    if (NULL != d3d10ext)
    {
        ...
        case DDS_RESOURCE_DIMENSION_TEXTURE1D:
        {
            ...
            res_dim = BRX_SAMPLED_ASSET_IMAGE_TYPE_1D;
        }
        break;
        case DDS_RESOURCE_DIMENSION_TEXTURE2D:
        {
            ...
            res_dim = BRX_SAMPLED_ASSET_IMAGE_TYPE_2D;
        }
        break;
        case DDS_RESOURCE_DIMENSION_TEXTURE3D:
        {
            ...
            res_dim = BRX_SAMPLED_ASSET_IMAGE_TYPE_3D;
        }
        break;
        default:
            return false;
...
extern bool import_image_asset_data_from_input_stream_dds(import_asset_input_stream *input_stream, BRX_SAMPLED_ASSET_IMAGE_IMPORT_HEADER const *image_asset_header, size_t image_asset_data_offset, void *staging_upload_buffer_base, size_t subresource_count, BRX_SAMPLED_ASSET_IMAGE_IMPORT_SUBRESOURCE_MEMCPY_DEST const *subresource_memcpy_dests)
{
#ifndef NDEBUG
    BRX_SAMPLED_ASSET_IMAGE_IMPORT_HEADER image_asset_header_for_validate;
    size_t image_asset_data_offset_for_validate;
    if (!import_image_asset_header_from_input_stream_dds(input_stream, &image_asset_header_for_validate, &image_asset_data_offset_for_validate))
    {
        return false;
    }
    ...
    if (-1 == input_stream->seek(image_asset_data_offset, IMPORT_ASSET_INPUT_STREAM_SEEK_SET))
    {
        return false;
    }
