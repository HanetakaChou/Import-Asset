...
#define brx_shader_byte_code_x_stringizing(string) brx_shader_byte_code_stringizing(string)
			// clang-format off
#include brx_shader_byte_code_x_stringizing(../shaders/brx_shader_byte_code/full_screen_transfer_vertex.inl)
#include brx_shader_byte_code_x_stringizing(../shaders/brx_shader_byte_code/full_screen_transfer_fragment.inl)
			// clang-format on
