...
{
	void *new_unwrapped_input_stream_factory_base = import_asset_malloc(sizeof(import_asset_memory_input_stream_factory), alignof(import_asset_memory_input_stream_factory));
...
void import_asset_memory_input_stream_factory::init(size_t input_stream_count, char const *const *input_stream_file_names, void const *const *input_stream_memory_range_bases, size_t const *input_stream_memory_range_sizes)
{
	...
	{
		import_asset_string input_stream_file_name = input_stream_file_names[input_stream_index];
...
{
	import_asset_string input_stream_file_name = file_name;
	...
	if (this->m_memory_ranges.end() != found)
	{
		...
		void *new_unwrapped_input_stream_base = import_asset_malloc(sizeof(import_asset_memory_input_stream), alignof(import_asset_memory_input_stream));
