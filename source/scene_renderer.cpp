...
#define brx_shader_byte_code_x_stringizing(string) brx_shader_byte_code_stringizing(string)
            // clang-format off
#include brx_shader_byte_code_x_stringizing(../shaders/brx_shader_byte_code/skin_compute.inl)
            // clang-format on
...
#define brx_shader_byte_code_x_stringizing(string) brx_shader_byte_code_stringizing(string)
            // clang-format off
#include brx_shader_byte_code_x_stringizing(../shaders/brx_shader_byte_code/forward_shading_vertex.inl)
#include brx_shader_byte_code_x_stringizing(../shaders/brx_shader_byte_code/forward_shading_fragment.inl)
            // clang-format on
#undef brx_shader_byte_code_stringizing
#undef brx_shader_byte_code_x_stringizing
...
#define brx_shader_byte_code_x_stringizing(string) brx_shader_byte_code_stringizing(string)
            // clang-format off
#include brx_shader_byte_code_x_stringizing(../shaders/brx_shader_byte_code/post_process_vertex.inl)
#include brx_shader_byte_code_x_stringizing(../shaders/brx_shader_byte_code/post_process_fragment.inl)
            // clang-format on
#undef brx_shader_byte_code_stringizing
#undef brx_shader_byte_code_x_stringizing
