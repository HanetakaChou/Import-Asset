...
//--------------------------------------------------------------------------------------
CD3DArcBall::CD3DArcBall() noexcept : m_mRotation{},
                                      m_mTranslation{},
                                      m_mTranslationDelta{},
                                      m_Offset{0, 0},
                                      m_nWidth(0),
...
_Use_decl_annotations_
    LRESULT
    CD3DArcBall::HandleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
// Constructor
//--------------------------------------------------------------------------------------
CBaseCamera::CBaseCamera() noexcept : m_mView{},
                                      m_mProj{},
                                      m_GamePad{},
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CBaseCamera::SetViewParams(CXMVECTOR vEyePt, CXMVECTOR vLookatPt)
{
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CBaseCamera::SetProjParams(float fFOV, float fAspect, float fNearPlane, float fFarPlane)
{
...
_Use_decl_annotations_
    LRESULT
    CBaseCamera::HandleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    switch (uMsg)
    {
    case WM_KEYDOWN:
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CBaseCamera::GetInput(bool bGetKeyboardInput, bool bGetMouseInput, bool bGetGamepadInput)
{
...
CFirstPersonCamera::CFirstPersonCamera() noexcept : m_mCameraWorld{},
...
void CFirstPersonCamera::FrameMove(_In_ float fElapsedTime)
{
    ...
    if ((m_nActiveButtonMask & m_nCurrentButtonMask) || m_bRotateWithoutButtonDown || m_vGamePadRightThumb.x != 0 || m_vGamePadRightThumb.z != 0)
    {
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CFirstPersonCamera::SetRotateButtons(bool bLeft, bool bMiddle, bool bRight, bool bRotateWithoutButtonDown)
{
...
CModelViewerCamera::CModelViewerCamera() noexcept : m_nRotateModelButtonMask(MOUSE_LEFT_BUTTON),
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CModelViewerCamera::SetViewParams(CXMVECTOR vEyePt, CXMVECTOR vLookatPt)
{
...
_Use_decl_annotations_
    LRESULT
    CModelViewerCamera::HandleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
CDXUTDirectionWidget::CDXUTDirectionWidget() noexcept : m_fRadius(1.0f),
...
_Use_decl_annotations_
    LRESULT
    CDXUTDirectionWidget::HandleMessages(HWND hWnd, UINT uMsg,
...
_Use_decl_annotations_
    HRESULT
    CDXUTDirectionWidget::OnRender(CXMVECTOR, CXMMATRIX, CXMMATRIX, CXMVECTOR)
{
    // TODO -
    return S_OK;
}
...
_Use_decl_annotations_
    HRESULT
    CDXUTDirectionWidget::StaticOnD3D11CreateDevice(ID3D11Device *, ID3D11DeviceContext *)
{
    // TODO -
    return S_OK;
}
