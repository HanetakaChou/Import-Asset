...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CDXUTBaseCamera::SetViewParams(DirectX::CXMVECTOR vEyePt, DirectX::CXMVECTOR vLookatPt, _In_ DirectX::CXMVECTOR vUp)
{
    ...
    DirectX::XMStoreFloat3(&zBasis, DirectX::XMVector3TransformNormal(DirectX::g_XMIdentityR2, mInvView));
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CDXUTBaseCamera::SetProjParams(float fFOV, float fAspect, float fNearPlane, float fFarPlane)
{
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CDXUTBaseCamera::UpdateKeyboardDirection()
{
    if (GetKeyBoardInput())
    {
...
// Figure out the velocity based on keyboard input & drag if any
//--------------------------------------------------------------------------------------
void CDXUTBaseCamera::UpdateVelocity(_In_ float fElapsedTime)
{
...
void CDXUTBaseCamera::Reset()
{
    ...
    DirectX::XMVECTOR vDefaultUp = DirectX::XMLoadFloat3(&m_vUp);
...
//--------------------------------------------------------------------------------------
void CDXUTFirstPersonCamera::FrameMove(_In_ float fElapsedTime)
{
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ void CDXUTFirstPersonCamera::SetRotateButtons(bool bLeft, bool bMiddle, bool bRight, bool bRotateWithoutButtonDown)
{
